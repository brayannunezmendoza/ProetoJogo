...
public class Entrar extends JFrame {
    ...
    public Entrar() {
        ...
        ///
         ...
         img_image1 = new ImageIcon(getClass().getResource("/IMG/Fundo_Login_Cadastrar.jpg"));
        ...
        img_imagem = new ImageIcon(getClass().getResource("/IMG/fundo_telaAbertura.png"));
